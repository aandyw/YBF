    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-8 bg-white">
      <div className="w-full max-w-5xl flex flex-col items-center justify-center flex-1 gap-8">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Your Biggest Fan</h1>
        ...
        <Card className="w-full max-w-md border border-gray-200 shadow-sm">
          <CardHeader className="pb-4">
            <h2 className="text-2xl font-semibold text-center text-gray-800">AI Chatbot for You</h2>
          </CardHeader>
          <CardContent>
            <p className="text-center text-gray-600">
              A personal AI assistant that acts as your biggest fan,
              providing support and encouragement for all your endeavors.
            </p>
          </CardContent>
